...
var makeHabitable = function(target){
	...
	var lookAround = function(player){
		...
		return ( target.lookAroundPrefix || lookAroundPrefix ).printf({ player : player, object : target })+target.listItems(player);
	};
...
var lookAroundPrefix = 'You are in %(object.description)s. ';
