...
var makeCommonObject = function(target, properties ){
	...
	*/
	...
	target.hasState = function(player,flag){
		return maskSafe( getState(player).stateMask ) & maskSafe( flag ) !== 0;
	}
	...
	var filterCommands = function(mask){
		return function(command){
			var isInMask = ( maskSafe( mask ) & command[2] ) === command[2];
			var isNotInNegMask = ( maskSafe( mask ) & command[3] ) === 0;
